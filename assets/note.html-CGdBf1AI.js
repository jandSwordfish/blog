import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as a,d as i,o as l}from"./app-D9S4WSkW.js";const e={};function p(d,s){return l(),a("div",null,[...s[0]||(s[0]=[i(`<h1 id="质数" tabindex="-1"><a class="header-anchor" href="#质数"><span>质数</span></a></h1><h2 id="_6倍速普通方法" tabindex="-1"><a class="header-anchor" href="#_6倍速普通方法"><span>6倍速普通方法</span></a></h2><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>bool isPrime(int n)</span></span>
